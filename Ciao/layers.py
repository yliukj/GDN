...
def dropout_sparse(x, keep_prob, num_nonzero_elems):
    ...
    random_tensor += tf.random_uniform(noise_shape,seed=None)
...
class GraphConvolution(Layer):
    ...
    def __init__(self, input_dim, output_dim, adj, dropout=0., act=tf.nn.relu, **kwargs):
        ...
        with tf.variable_scope(self.name + '_vars'):
            ...
            self.vars['weights2'] = weight_variable_glorot(input_dim, output_dim, name="weights")
...
class GraphConvolutionSparse(Layer):
    ...
    def __init__(self, input_dim, output_dim, adj, features_nonzero, dropout=0., act=tf.nn.relu, **kwargs):
        ...
        with tf.variable_scope(self.name + '_vars'):
            ...
            self.vars['weights2'] = weight_variable_glorot(output_dim, output_dim, name="weights")
        self.dropout = dropout
        self.adj = adj
        self.act = act
        self.issparse = True
